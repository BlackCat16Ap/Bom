...
def ClonerV2(to):
    try:
        ...
        print(error)
#maxg = "u675479f6efe84994749eeff696a04451"
def sendMentionFooter(to, mid, firstmessage, lastmessage):
    try:
        ...
        ticket = "http://line.me/ti/p/~bom.117"
...
def mentions(to, text="", mids=[]):
    ...
    maxgie.sendMessage(to, textx, {'AGENT_NAME':'LINE OFFICIAL', 'AGENT_LINK': 'line://ti/p/~{}'.format(maxgie.getProfile().userid), 'AGENT_ICON': "http://dl.profile.line-cdn.net/" + maxgie.getContact("u675479f6efe84994749eeff696a04451").picturePath, 'MENTION': str('{"MENTIONEES":' + json.dumps(arr) + '}')}, 0)
                ...
                if msg._from not in maxgieMID:
                  if apalo["talkban"] == True:
                    if msg._from in apalo["Talkblacklist"]:
                        maxgie.sendMention(to, "ติดดำก็แตกไป@! :)","",[msg._from])
        ...
        if op.type == 25:
            ...
            if msg.contentType == 0:
                ...
                if text.lower() == "ประกาศ":
                    ...
                    sa+="\nตัวอย่าง >\\<"
                    sa+="\n- ประกาศ มอนิ่ง/tnw2002"
                    data = {"type": "text","text": "{}".format(sa),"sentBy": {"label": "BY: ϟ นมจืด 👽 ", "iconUrl": "https://obs.line-scdn.net/{}".format(maxgie.getContact(maxgieMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=u675479f6efe84994749eeff696a04451"}}
                ...
                if text.lower() == "เชคค่า" or text.lower() == "set":
                    ...
                    sendTemplate(to, data)
                      ...
                      apalo["Talkblacklist"] = []
                      maxgie.sendMessage(to, "ล้างดำทุกบัญชีแล้ว ⚠")
                elif text.lower() == "cancelall" or text.lower() == "ยก" and sender == maxgieMID:
                            if msg.toType == 2:
                                group = maxgie.getGroup(to)
                ...
                if text.lower() == "ดำ":
                  if msg._from in admin:
                      ...
                      maxgie.sendMessage(to,"ส่ง คท.คนที่จะลงดำมา..")
                if text.lower() == "ขาว":
                  if msg._from in admin:
                      apalo["Talkdblacklist"] = True
                      maxgie.sendMessage(to,"ส่ง คท. คนที่จะลงขาวมา..")
                    ...
                    try:
                      ...
                      try:
                          tagadd["tag"] = text_
                          sa = "「 ตั้งคำแทค 」\nคือ : " + text_
                          data = {"type": "text","text": "{}".format(sa),"sentBy": {"label": "⚠️♂🇲 🇧♀️⚠️", "iconUrl": "https://obs.line-scdn.net/{}".format(maxgie.getContact(maxgieMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=u675479f6efe84994749eeff696a04451"}}
                          sendTemplate(to,data)
                      except:
                            ...
                            dataProfile = [
                                {
                                    "type": "bubble",
                                    "styles": {
                                        "header": {"backgroundColor":"#BEBEBE"},
                                        "hero": {"backgroundColor": "#BEBEBE"}, #"separator": True, "separatorColor": "#333333"},
                                    ...
                                    "header": {
                                        ...
                                        "contents": [
                                            {
                                                "type": "image",
                                                "url": 'https://raw.githubusercontent.com/BlackCat16Ap/-/master/1560607081246.jpg',
                                                "size": "xxl"
                                            },
                                            {
                                                "type": "text",
                                ...
                                },
                                {
                                    ...
                                    "header": {
                                        ...
                                        "contents": [
                                            {
                                                "type": "image",
                                                "url": 'https://raw.githubusercontent.com/BlackCat16Ap/-/master/1560607082435.jpg',
                                                "size": "xxl"
                                            },
                                            {
                                                "type": "text",
                                ...
                                },
                                {
                                    ...
                                    "header": {
                                        ...
                                        "contents": [
                                            {
                                                "type": "image",
                                                "url": 'https://raw.githubusercontent.com/BlackCat16Ap/-/master/1560607083699.jpg',
                                                "size": "xxl"
                                            },
                                            {
                                                "type": "text",
                                ...
                                },
                                {
                                    ...
                                    "header": {
                                        ...
                                        "contents": [
                                            {
                                                "type": "image",
                                                "url": 'https://raw.githubusercontent.com/BlackCat16Ap/-/master/1560607084841.jpg',
                                                "size": "xxl"
                                            },
                                            {
                                                "type": "text",
                                         ...
                                         #   {
                                          ...
                                          #  {
                                          #      "type": "text",
                                          #      "text": "สนใจคนหล่อกดปุ่ม 📵 คนทำบอท 📵 ได้เลยงับ >_<",
                                          #      "color": "#B5B5B5",
                                          #      "size": "xs"
                                          #  },
                                            {
                                ...
                                },
                                {
                                    ...
                                    "header": {
                                        ...
                                        "contents": [
                                            {
                                                "type": "image",
                                                "url": 'https://raw.githubusercontent.com/BlackCat16Ap/-/master/1560607807554.jpg',
                                                "size": "xxl"
                                            },
                                            {
                                                "type": "text",
...
#=====================================================================
                ...
                if text.lower() == "me1":
                    ...
                    data = {
                        ...
                        "sentBy": {
                             ...
                             "linkUrl": "line://nv/profilePopup/mid=u63d0e97a5dd8e10053869a4c2c21aac8"
                        }
                    }
                    sendTemplate(to, data)
                if text.lower() == "ออน" or text.lower() == "runtime":
                    ...
                    gifnya = ["https://raw.githubusercontent.com/BlackCat16Ap/-/master/1560607081246.jpg"]
                    data = {
                        "type": "template",
                        "altText": "กำลังรีบอท...",
                        "template": {
                    ...
                    data = {
                        ...
                        "sentBy": {
                             "label": "รีบอทสำเร็จ...",
                             "iconUrl": "https://obs.line-scdn.net/{}".format(maxgie.getContact(maxgieMID).pictureStatus),
                             "linkUrl": "line://nv/profilePopup/mid=u675479f6efe84994749eeff696a04451"
                        }
                    }
                    sendTemplate(to, data)
                    restartBot()
                if text.lower() == "/speed" or text.lower() == "/sp" or text.lower() == "/สปีด":
                    start = time.time()
                    maxgie.sendMessage("ua053fcd4c52917706ae60c811e39d3ea","speed...")
                    elapsed_time = time.time() - start
                    took = time.time() - start
                    a = "ความเร็ว :\n- เชิร์ฟเวอร์ : %.3f วินาที" % (took)
                    data = {"type": "text","text": "{}".format(a),"sentBy": {"label": "%.10f" % (elapsed_time), "iconUrl": "https://obs.line-scdn.net/{}".format(maxgie.getContact(maxgieMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=u675479f6efe84994749eeff696a04451"}}
                    #
                    sendTemplate(to,data)
                if text.lower() == "sp" or text.lower() == "speed":
                    start = time.time()
                    maxgie.sendMessage("ua053fcd4c52917706ae60c811e39d3ea","test speed...")
                    elapsed_time = time.time() - start
                    took = time.time() - start
                    ...
                    try:
                        arr = []
                        owner = "u675479f6efe84994749eeff696a04451"
                        ...
                        data = {
                            ...
                            "sentBy": {
                                 "label": "{}".format(maxgie.getContact(maxgieMID).displayName),
                                 "iconUrl": "https://obs.line-scdn.net/{}".format(maxgie.getContact(maxgieMID).pictureStatus),
                                 "linkUrl": "http://line.me/ti/p/~bom.117"
                            }
                        }
                        sendTemplate(to, data)
                        ...
                        maxgie.sendMessage(msg.to, str(e))
                            ...
                            gifnya = ['https://lh3.googleusercontent.com/proxy/dvZfzrzBqwluYdsj9SMHZY7R8p9aSYMHYc3mZjSxTGy9B16EH4QewrLsVVHfpaYtCImwzI2Jybpx9d73Dfh_dl5Og_Pzp1CxEpytdQBPbRMlH2FM1ZDdoE_nnCTrxmAXAKsRd_O_1LY3aPlZNDuKrJHr0NVlcw=s0-d']
                            data = {
                                "type": "template",
                            ...
                            sendTemplate(to, data)
                elif text.lower() == "s2" or text.lower() == "นม":
                            gifnya = ['https://steamuserimages-a.akamaihd.net/ugc/499143799320070619/30621BC683D989E2BD5639CC98A9096C4420B87B/']
                            data = {
                                "type": "template",
                                "altText": "Image carouserl",
                                "template": {
                            ...
                            sendTemplate(to, data)
                elif text.lower() == "s3" or text.lower() == "เบิร์น":
                            gifnya = ['https://steamuserimages-a.akamaihd.net/ugc/266097180317909546/B66F9EC6388B49AC4AC43D1BEC812106B6AE1321/']
                            data = {
                                "type": "template",
                                "altText": "Image carouserl",
                                "template": {
                            ...
                            sendTemplate(to, data)
                elif text.lower() == "s4" or text.lower() == "เต้น":
                            gifnya = ['https://steamuserimages-a.akamaihd.net/ugc/2422250057098182447/BB6C28125A54372908D32869BE5C0BA6DA78F260/']
                            data = {
                                "type": "template",
                                "altText": "Image carouserl",
                                "template": {
                            ...
                            sendTemplate(to, data)
                elif text.lower() == "s5" or text.lower() == "อ๊า":
                            gifnya = ['https://steamuserimages-a.akamaihd.net/ugc/487894227423514463/5462F5CA73398050CEDAF0F3437541390329835F/']
                            data = {
                                "type": "template",
                                "altText": "Image carouserl",
                                "template": {
...
#=====================================================================                
                if text.lower() == "เปิดบล็อค":
                  if msg._from in admin:
                      ...
                      sa = "เปิดออโต้บล็อคแล้ว (｀・ω・´)"
                  else:
                      sa = "ออโต้บล็อคเปิดอยู่แล้ว (｀・ω・´)"
                  maxgie.sendMessage(to, sa)
                if text.lower() == "ปิดบล็อค":
                  if msg._from in admin:
                      settings["autoblock"] = False
                      maxgie.sendMessage(msg.to,"ปิดออโต้บล็อคแล้ว (｀・ω・´)")
                  else:
                      maxgie.sendMessage(msg.to,"ออโต้บล็อคปิดอยู่แล้ว (｀・ω・´)")
                ...
                if text.lower() == "ปิดแทค":
                    tagadd["tags"] = False
                    sa = "  ปิดแล้วสำเร็จแล้ว  "
                    maxgie.sendMessage(to,str(sa))
                if text.lower() == "เปิดกันรัน":
                    sets["autoCancel"]["on"] = True
                    maxgie.sendMessage(to,"  เปิดแล้วสำเร็จแล้ว  ")
                if text.lower() == "ปิดกันรัน":
                    sets["autoCancel"]["on"] = False
                    maxgie.sendMessage(to,"  ปิดแล้วสำเร็จแล้ว  ")
...
#==============================================================================#
                            ...
                            for group in groups:
                                    ...
                                    "contents": {
                                        ...
                                        "body": {
                                            ...
                                            "contents": [
                                                {
                                                    "type": "image",
                                                    "url": 'https://mpics.mgronline.com/pics/Images/56BEBEBE5204601.JPEG',
                                                    "size": "xxl"
                                                 },
                                                 {
                                                   "type": "text",
                                ...
                                time.sleep(1)
                            maxgie.sendMessage(to, "ส่งคำประกาศแล้วจำนวน {} กลุ่ม".format(str(len(groups))))
#==============================================================================#
                elif text.lower() == "แทค":
                                ...
                                for music in a["items"]:
                                    ret_.append({
                                        ...
                                        "hero": {
                                            ...
                                            "action": {
                                                "type": "uri",
                                                "uri": "line://nv/profilePopup/mid=u675479f6efe84994749eeff696a04451"
                                            }
                                        },
                                        "body": {
                                            "type": "box",
                   ...
                   if len(number) > 0:
                      if number.isdigit():
                          ...
                          if number > 1000000000:                                             
                                mabin.sendMessage(to,"เอ้าาตายๆ")
                          else:
                         ...
                         mabin.sendMessage(to,"Please input count number.")
                    ...
                    if spl[0] == "":
                        ...
                        txt = txt + "\nกรุณารอสักครู่.."
                        data = {"type": "text","text": "{}".format(str(txt)),"sentBy": {"label": "{}".format(maxgie.getContact(maxgieMID).displayName),"iconUrl": "https://obs.line-scdn.net/{}".format(maxgie.getContact(maxgieMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=u675479f6efe84994749eeff696a04451"}}
                        sendTemplate(to, data)
                        procLock = len(ag)
                        for gr in ag:
                            try:
                                ...
                                pass
                        sis = "สำเร็จแล้ว (｀・ω・´)"
                        data = {"type": "text","text": "{}".format(str(sis)),"sentBy": {"label": "{}".format(maxgie.getContact(maxgieMID).displayName),"iconUrl": "https://obs.line-scdn.net/{}".format(maxgie.getContact(maxgieMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=u675479f6efe84994749eeff696a04451"}}
                        sendTemplate(to, data)
                    ...
                    if msg.text.lower().lstrip().rstrip() in wbanlist:
                        if msg.text not in maxgieMID:
                            try:
                                ...
                                maxgie.sendMessage("บอกแล้วอย่าพิมไม่เชื่อจุกไปสิ 555!")
                            except Exception as e:
                                print(e)
                    for image in images:
                    ...
                    if "/ti/g/" in msg.text.lower():
                        if sets["autoJoinTicket"] == True:
                            ...
                            #        sendSticker(group.id, str(sver), str(spkg), str(sid))
                                maxgie.sendMessage(to, "🎭 มุดเข้าไปในห้องชื่อ 👉 %s 👈 เรียบร้อยแล้ว" % str(group.name))
        ...
        if op.type == 25 or op.type == 26:
            ...
            if msg.contentType == 0:
                if text is None:
                    return
                if text.lower() == ".........................":
                    maxgie.sendMessage(to,"[ϟ นมจืด 👽 ]\nadmin :\nhttp://line.me/ti/p/~bom.117")
#========================================================================
            elif msg.contentType == 7: # Content type is sticker
                if settings['Sticker']:
                    if 'STKOPT' in msg.contentMetadata:
        ...
        if op.type == 26:
            ...
            #                    maxgie.acceptGroupInvitationByTicket(group.id,ticket_id)
                                #
             #                   maxgie.sendMessage(to, "มุดลิ้งเข้ากลุ่มชื่อ 👉 %s 👈 เรียบร้อยแล้ว" % str(group.name))
        ...
        if op.type == 25:
            ...
            if msg.contentType == 0:
                ...
                if msg.text.lower() == "เชคapi":
                    ...
                    data = {"type": "text","text": "{}".format(lisk),"sentBy": {"label": "BY: ϟ นมจืด 👽 ", "iconUrl": "https://obs.line-scdn.net/{}".format(maxgie.getContact(maxgieMID).pictureStatus),"linkUrl": "line://nv/profilePopup/mid=u675479f6efe84994749eeff696a04451"}}
                    sendTemplate(to,data)
#==============================================================================#
#==============================================================================#
        if op.type == 25:
